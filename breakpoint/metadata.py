...
ATTACK_KNOWLEDGE_BASE = {
    ...
    "union_sqli": {
        ...
        "risk_tier": RiskTier.CRITICAL,
        "destructive": True,
        "impact_simulation": "Data exfiltration through UNION SELECT.",
        "impact_execution": "Probes column count and reflects unique strings.",
        "confidence": "HIGH",
        "description": "Dumps database content by appending UNION SELECT statements.",
    },
    "dom_xss": {
        "name": "DOM-based XSS",
        "severity": "MEDIUM",
        "risk_tier": RiskTier.MEDIUM,
        "destructive": False,
        "impact_simulation": "Script execution in victim's browser context.",
        "impact_execution": "Identifies dangerous JS sinks in client code.",
        "confidence": "MEDIUM",
        "description": "Exploits unsafe handling of DOM elements in client-side scripts.",
    },
    "csrf": {
        ...
        "risk_tier": RiskTier.HIGH,
        "destructive": True,
        "impact_simulation": "Unauthorized actions performed on behalf of user.",
        "impact_execution": "Checks for missing anti-CSRF tokens in state-changing forms.",
        "confidence": "HIGH",
        "description": "Tricks users into submitting unintentional requests.",
    },
    "dependency_confusion": {
        ...
        "risk_tier": RiskTier.CRITICAL,
        "destructive": True,
        "impact_simulation": "Full server compromise via malicious package install.",
        "impact_execution": "Detects internal namespace leaks in package manifests.",
        "confidence": "HIGH",
        "description": "Injects malicious code by spoofing internal package names in public npm/pypi repositories.",
    },
    "archive_bomb": {
        ...
        "risk_tier": RiskTier.HIGH,
        "destructive": True,
        "impact_simulation": "Disk or RAM exhaustion causing server crash.",
        "impact_execution": "Probes file upload handlers with dense compression patterns.",
        "confidence": "MEDIUM",
        "description": "Sends nested or highly compressed archives to induce DoS.",
    },
